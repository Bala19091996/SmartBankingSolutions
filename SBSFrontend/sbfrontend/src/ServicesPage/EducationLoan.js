...
const EducationLoan = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        tenureInMonths: "",
        loanType: "EDUCATION", // Default loan type
    });
    ...
    const handleLoanApplication = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                setSuccess("Education loan application submitted successfully! Our team will contact you soon.");
                setFormData({
    ...
    return (
        <div style={styles.container}>
            ...
            <h1 style={styles.header}>🎓 Education Loan Application</h1>
            <p style={styles.info}>Apply for an education loan with easy repayment options.</p>
