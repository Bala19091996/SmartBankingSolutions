...
const CarLoan = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        tenureInMonths: "",
        loanType: "CARLOAN", // Default loan type
    });
    ...
    return (
        <div style={styles.container}>
            ...
            <h1 style={styles.header}>🚗 Car Loan Application</h1>
            <p style={styles.info}>Apply for a car loan with competitive interest rates and easy repayment plans.</p>
